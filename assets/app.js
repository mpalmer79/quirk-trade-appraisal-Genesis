...
(function i18nFull(){
  ...
  const MAP_EN_ES = new Map([
    ...
    ["backToDealer", "Volver a Genesis of Braintree"],
    ["successTitle", "¡Gracias! - Genesis of Braintree"],
    ["successHeading", "¡Gracias!"],
    ["successMessage", "Hemos recibido los detalles de su intercambio. Un especialista de Genesis of Braintree se pondrá en contacto con usted en breve."]
  ]);
